...
const { default: hamConnect, useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require("baileys")
...
const store = makeInMemoryStore({ logger: pino().child({ level: 'silent', stream: 'debug' }) })
